...
[Automatic worktree cleanup](../worktree-cleanup/) is owned by the background runtime and applies across agents and tools. It verifies merge and ownership state without cleanup prompts.
