...
impl Params {
    ...
    pub(crate) fn checkpoint_parts(&self) -> ([u8; MAX_PARAMS], [u16; MAX_PARAMS], u8, usize) {
        (self.subparams, self.params, self.current_subparams, self.len)
    }
    ...
    pub(crate) fn from_checkpoint_parts(
        ...
        Self { subparams, params, current_subparams, len }
    }
}
